...
import com.piperbloom.proxyvpn.extension.toSpeedString
...
//        val startMainIntent = Intent(service, MainActivity::class.java)
        ...
        mBuilder = NotificationCompat.Builder(service, channelId)
                ...
                .setContentTitle(getCountryName(currentConfig?.remarks.toString()))
...
//        .build()
    ...
    private fun createNotificationChannel(): String {
        val channelId = "PI_PP_ER_CH_ID"
        val channelName = "Pipper Background Service"
    ...
    private fun updateNotification(contentText: String?, proxyTraffic: Long, directTraffic: Long) {
        if (mBuilder != null) {
            if (proxyTraffic < NOTIFICATION_ICON_THRESHOLD && directTraffic < NOTIFICATION_ICON_THRESHOLD) {
                mBuilder?.setSmallIcon(R.drawable.ic_stat_name2)
