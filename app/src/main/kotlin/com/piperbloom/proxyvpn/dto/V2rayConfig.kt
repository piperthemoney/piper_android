...
data class V2rayConfig(
    ...
    data class OutboundBean(var tag: String = "proxy",
        ...
        fun getServerAddress(): String? {
            if (protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.VMESS.name, true)
                    || protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.VLESS.name, true)) {
                return settings?.vnext?.get(0)?.address
            } else if (protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.SHADOWSOCKS.name, true)
                    || protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.SOCKS.name, true)
                    || protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.TROJAN.name, true)) {
                return settings?.servers?.get(0)?.address
            } else if (protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.WIREGUARD.name, true)) {
        ...
        fun getPassword(): String? {
            ...
            } else if (protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.SOCKS.name, true)) {
        ...
        fun getSecurityEncryption(): String? {
            return when {
                protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.VMESS.name, true) -> settings?.vnext?.get(0)?.users?.get(0)?.security
                protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.VLESS.name, true) -> settings?.vnext?.get(0)?.users?.get(0)?.encryption
                protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.SHADOWSOCKS.name, true) -> settings?.servers?.get(0)?.method
                else -> null
            }
        }
        ...
        fun getTransportSettingDetails(): List<String>? {
            if (protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.VMESS.name, true)
                    || protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.VLESS.name, true)
                    || protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.TROJAN.name, true)
                    || protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.SHADOWSOCKS.name, true)) {
    ...
    fun getProxyOutbound(): OutboundBean? {
        outbounds.forEach { outbound ->
            com.piperbloom.proxyvpn.dto.EConfigType.entries.forEach {
