...
import com.piperbloom.proxyvpn.AppConfig.PROTOCOL_FREEDOM
import com.piperbloom.proxyvpn.AppConfig.TAG_DIRECT
import com.piperbloom.proxyvpn.AppConfig.TAG_FRAGMENT
import com.piperbloom.proxyvpn.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import com.piperbloom.proxyvpn.AppConfig.WIREGUARD_LOCAL_ADDRESS_V6
import com.piperbloom.proxyvpn.dto.EConfigType
import com.piperbloom.proxyvpn.dto.ERoutingMode
import com.piperbloom.proxyvpn.dto.V2rayConfig
import com.piperbloom.proxyvpn.dto.V2rayConfig.Companion.DEFAULT_NETWORK
import com.piperbloom.proxyvpn.dto.V2rayConfig.Companion.HTTP
...
object V2rayConfigUtil {
    ...
    fun getV2rayConfig(context: Context, guid: String): Result {
        try {
            ...
            if (config.configType == com.piperbloom.proxyvpn.dto.EConfigType.CUSTOM) {
...
//            v2rayConfig.routing.domainMatcher = "mph"
    ...
    private fun updateOutboundWithGlobalSettings(outbound: V2rayConfig.OutboundBean): Boolean {
        try {
            ...
            if (protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.SHADOWSOCKS.name, true)
                ...
                || protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.WIREGUARD.name, true)
            ) {
                muxEnabled = false
            } else if (protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.VLESS.name, true)
            ...
            if (protocol.equals(com.piperbloom.proxyvpn.dto.EConfigType.WIREGUARD.name, true)) {
