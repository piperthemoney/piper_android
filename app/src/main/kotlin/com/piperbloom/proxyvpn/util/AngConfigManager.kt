...
import com.piperbloom.proxyvpn.dto.*
import com.piperbloom.proxyvpn.util.MmkvManager.KEY_SELECTED_SERVER
import com.piperbloom.proxyvpn.util.fmt.ShadowsocksFmt
import com.piperbloom.proxyvpn.util.fmt.SocksFmt
import com.piperbloom.proxyvpn.util.fmt.TrojanFmt
import com.piperbloom.proxyvpn.util.fmt.VlessFmt
import com.piperbloom.proxyvpn.util.fmt.VmessFmt
import com.piperbloom.proxyvpn.util.fmt.WireguardFmt
...
//    }
    ...
    private fun parseConfig(
        ...
        try {
            ...
            val config = if (str.startsWith(com.piperbloom.proxyvpn.dto.EConfigType.VMESS.protocolScheme)) {
                VmessFmt.parseVmess(str)
            } else if (str.startsWith(com.piperbloom.proxyvpn.dto.EConfigType.SHADOWSOCKS.protocolScheme)) {
                ShadowsocksFmt.parseShadowsocks(str)
            } else if (str.startsWith(com.piperbloom.proxyvpn.dto.EConfigType.SOCKS.protocolScheme)) {
                SocksFmt.parseSocks(str)
            } else if (str.startsWith(com.piperbloom.proxyvpn.dto.EConfigType.TROJAN.protocolScheme)) {
                TrojanFmt.parseTrojan(str)
            } else if (str.startsWith(com.piperbloom.proxyvpn.dto.EConfigType.VLESS.protocolScheme)) {
                VlessFmt.parseVless(str)
            } else if (str.startsWith(com.piperbloom.proxyvpn.dto.EConfigType.WIREGUARD.protocolScheme)) {
    ...
    fun shareConfig(guid: String): String {
        try {
            ...
            return config.configType.protocolScheme + when (config.configType) {
                com.piperbloom.proxyvpn.dto.EConfigType.VMESS -> VmessFmt.toUri(config)
                com.piperbloom.proxyvpn.dto.EConfigType.CUSTOM -> ""
                com.piperbloom.proxyvpn.dto.EConfigType.SHADOWSOCKS -> ShadowsocksFmt.toUri(config)
                com.piperbloom.proxyvpn.dto.EConfigType.SOCKS -> SocksFmt.toUri(config)
                com.piperbloom.proxyvpn.dto.EConfigType.VLESS -> VlessFmt.toUri(config)
                com.piperbloom.proxyvpn.dto.EConfigType.TROJAN -> TrojanFmt.toUri(config)
                com.piperbloom.proxyvpn.dto.EConfigType.WIREGUARD -> WireguardFmt.toUri(config)
            }
        } catch (e: Exception) {
            e.printStackTrace()
            return ""
