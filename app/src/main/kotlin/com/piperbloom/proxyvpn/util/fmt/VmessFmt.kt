...
import com.piperbloom.proxyvpn.dto.VmessQRCode
import com.piperbloom.proxyvpn.extension.idnHost
...
object VmessFmt {
    ...
    fun parseVmess(str: String): ServerConfig? {
        ...
        val config = ServerConfig.create(com.piperbloom.proxyvpn.dto.EConfigType.VMESS)
        ...
        if (!tryParseNewVmess(str, config, allowInsecure)) {
            if (str.indexOf("?") > 0) {
                ...
                var result = str.replace(com.piperbloom.proxyvpn.dto.EConfigType.VMESS.protocolScheme, "")
    ...
    private fun tryResolveVmess4Kitsunebi(server: String, config: ServerConfig): Boolean {
        ...
        var result = server.replace(com.piperbloom.proxyvpn.dto.EConfigType.VMESS.protocolScheme, "")
